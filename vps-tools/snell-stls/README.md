...
⚠️ **先决策**：这套组合**只 Surge 能用**。如果你的客户端是 Shadowrocket / v2rayN / NekoBox 等，请直接换 [`../anytls/`](../anytls/README.md)，下面的步骤就不用看了。
...
只有 **[Surge](https://nssurge.com/)**（iOS / macOS）能用——Snell v5 + ShadowTLS v3 是 Surge 独家组合。

如果你用 Shadowrocket / v2rayN / NekoBox 等任何其它客户端，请改用 [`../anytls/`](../anytls/README.md)。
