...
const TILES_CONFIG = [
    // 特殊地块
    { name: '起点地块', description: '大富翁起点格子，GO标识，绿色背景，箭头指示，庆祝元素' },
    { name: '监狱地块', description: '监狱格子，灰色石墙，铁栅栏，警告标志，等距视角' },
    { name: '免费停车', description: '免费停车格子，停车标志，蓝色P字，友好图标' },
    { name: '去监狱', description: '去监狱指示格子，红色警察帽，逮捕手势，方向箭头' },
    ...
    // 房产等级 - 红色地产群
    { name: '红色地产房屋L1', description: '红色地产简易房屋，木质结构，红色屋顶，等级1建筑' },
    { name: '红色地产房屋L2', description: '红色地产砖房，两层建筑，红色外墙，等级2升级' },
    { name: '红色地产别墅L3', description: '红色地产别墅，花园设计，豪华外观，等级3建筑' },
    { name: '红色地产酒店L4', description: '红色地产精品酒店，现代设计，玻璃幕墙，等级4建筑' },
    { name: '红色地产摩天楼L5', description: '红色地产摩天大楼，未来主义，LED灯光，等级5顶级' },
